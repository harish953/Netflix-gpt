...
const VideoTitle = ({ title, overview }) => {
  return (
    <div className="w-screen aspect-video pt-[15%] px-24 absolute bg-gradient-to-r from-black ">
      ...
      <div>
        <button className="m-4 px-4 py-2 bg-gray-600 text-black bg-white  rounded-md hover:bg-opacity-50">
          ▶️Play
        </button>
        <button className="px-4 py-2 bg-gray-600 rounded-md text-white text-lg marker:rounded-md">
          More Info
        </button>
      </div>
    </div>
